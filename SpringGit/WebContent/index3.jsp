...
function llamadaRest()
{
	...
	xmlHttp.open('GET', 'personaJSON?name=' + nombre + "&edad=" + edad + "&desc=" + desc, true); //indicamos como vamos a enviar los datos, en este caso con el metodo GET al archivo meses.php?num= el valor que le indiquemos en el textbox
